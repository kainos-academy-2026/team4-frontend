...
export const fallbackJobRoles: JobRole[] = [
	{
		...
		status: "open",
		description:
			"Design and build backend services using modern cloud-native technologies using modern cloud-native technologies.",
		responsibilities:
			"Deliver features, review code, and support production production releases.",
