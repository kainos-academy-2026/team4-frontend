(function () {
	...
	if (page === "job-application") {
		...
		const confirmationSection = document.querySelector("[data-application-confirmation]");
		const confirmationText = document.querySelector("[data-application-confirmation-text]");
