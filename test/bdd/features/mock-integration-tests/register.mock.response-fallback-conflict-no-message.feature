...
Feature: Register user page
  ...
  Scenario: Conflict without response message uses generic fallback message
    Given I am on the register page
    And the register API responds with conflict and no message
    When I submit registration with email "fallback.conflict@example.com" and password "StrongPass1!"
